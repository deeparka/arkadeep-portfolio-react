...
import { handleTwitter2Code, handleTwitter2LiveLink } from "../lib/projectHelper";
...
function Projects() {
  return (
    <div className="mb-6 pt-16 px-6 flex flex-wrap justify-around gap-5 sm:px-8 sm:pt-20 md:px-16 lg:px-100px">
        ...
        <div className="py-4 px-6">
          <div className="space-y-3">
            ...
            <div className="flex space-x-4">
              <FaGithub className="h-6 w-6 transition transform ease-in-out hover:scale-125" onClick={handleTwitter2Code} />
              <FiExternalLink className="h-6 w-6 transition transform ease-in-out hover:scale-125" onClick={handleTwitter2LiveLink} />
            </div>
            </div>
      ...
      <div className="max-w-sm rounded-xl overflow-hidden mt-8 lg:mt-14 py-4 px-6 bg-customGrey group transition transform ease-in-out delay-100 hover:scale-110 hover:-translate-y-1">
        <div className="space-y-3">
