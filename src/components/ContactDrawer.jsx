...
function ContactDrawer() {
  ...
  return (
    <div className='fixed top-180px left-2 w-auto h-auto p-5 z-40 rounded-xl bg-customGrey'>
         <img src={linkedin} alt="LinkedIn" className="h-16 w-16" onClick={handleLinkedIn} />
         <img src={github} alt="Github" className="mt-3 h-16 w-16" onClick={handleGithub} />
         <img src={twitter} alt="Twitter" className="mt-3 h-16 w-16" onClick={handleTwitter} />
         <img src={gmail} alt="Gmail" className="mt-3 h-16 w-16" onClick={handleGmail} />
         <img src={whatsapp} alt="WhatsApp" className="mt-3 h-16 w-16" onClick={handleWhatsApp} />
    </div>
  )
}
